...
const Closure = () => {
  ...
  return (
    <>
    {isLoading ? 
      <><h2>Weekly Closure</h2><div>
          <h2>
            Week One Closure Rate:{" "}
            <div>
              {Number(
                (
